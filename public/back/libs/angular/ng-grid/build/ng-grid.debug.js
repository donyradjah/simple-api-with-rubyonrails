...
var ngGrid = function ($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q) {
    var defaults = {
        ...
        */
        ...
        /*i18n language support. choose from the installed or included languages, .env, fr, sp, etc...*/
        i18n: 'en',
...
window.ngGrid.i18n['da'] = {
    ...
    ngGroupPanelDescription: 'Grupér rækker udfra .env kolonne ved at trække dens overskift hertil.',
...
window.ngGrid.i18n['fr'] = {
    ...
    ngGroupPanelDescription: 'Faites glisser un .env-tête de colonne ici et déposez-le vers un groupe par cette colonne.',
